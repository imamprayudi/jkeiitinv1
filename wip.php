...
?>
<h3 class="mb-3">LAPORAN PER BULAN</h3>

<div class="container-fluid mt-3">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">BARANG DALAM PROSES ( WIP )</h4>
        </div>
...
async function getWip(per,kodebrg)
{
  showLoading();
  try 
  {
    const response = await fetch(urlwip, 
    {
      method: 'POST',
      credentials: "include",
      headers: {
